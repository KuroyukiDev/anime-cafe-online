...
router.get('/', (req, res) => {
  ...
  let anime = animeData.anime[7];
  
  res.render('haganai.hbs', {
    pageTitle: anime.name1,
    pageTitle2: anime.name2,
    banner: anime.imgSrc,
    ep1: {
      name: `${anime.name1} - EP #${anime.eps[0].ep_num}`,
      id: `/dubbed${anime.eps[0].id}`
    },
    ep2: {
      name: `${anime.name1} - EP #${anime.eps[1].ep_num}`,
      id: `/dubbed${anime.eps[1].id}`
    },
    ep3: {
      name: `${anime.name1} - EP #${anime.eps[2].ep_num}`,
      id: `/dubbed${anime.eps[2].id}`
    },
    ep4: {
      name: `${anime.name1} - EP #${anime.eps[3].ep_num}`,
      id: `/dubbed${anime.eps[3].id}`
    },
    ep5: {
      name: `${anime.name1} - EP #${anime.eps[4].ep_num}`,
      id: `/dubbed${anime.eps[4].id}`
    },
    ep6: {
      name: `${anime.name1} - EP #${anime.eps[5].ep_num}`,
      id: `/dubbed${anime.eps[5].id}`
    },
    ep7: {
      name: `${anime.name1} - EP #${anime.eps[6].ep_num}`,
      id: `/dubbed${anime.eps[6].id}`
    },
    ep8: {
      name: `${anime.name1} - EP #${anime.eps[7].ep_num}`,
      id: `/dubbed${anime.eps[7].id}`
    },
    ep9: {
      name: `${anime.name1} - EP #${anime.eps[8].ep_num}`,
      id: `/dubbed${anime.eps[8].id}`
    },
    ep10: {
      name: `${anime.name1} - EP #${anime.eps[9].ep_num}`,
      id: `/dubbed${anime.eps[9].id}`
    },
    ep11: {
      name: `${anime.name1} - EP #${anime.eps[10].ep_num}`,
      id: `/dubbed${anime.eps[10].id}`
    },
    ep12: {
      name: `${anime.name1} - EP #${anime.eps[11].ep_num}`,
      id: `/dubbed${anime.eps[11].id}`
    },
    ep13: {
      name: `${anime.name1} - EP #${anime.eps[12].ep_num}`,
      id: `/dubbed${anime.eps[12].id}`
    },
    ep14: { // Haganai Next EPs Start Here
      name: `${anime.name2} - EP #${anime.eps[13].ep_num}`,
      id: `/dubbed${anime.eps[13].id}`
    },
    ep15: {
      name: `${anime.name2} - EP #${anime.eps[14].ep_num}`,
      id: `/dubbed${anime.eps[14].id}`
    },
    ep16: {
      name: `${anime.name2} - EP #${anime.eps[15].ep_num}`,
      id: `/dubbed${anime.eps[15].id}`
    },
    ep17: {
      name: `${anime.name2} - EP #${anime.eps[16].ep_num}`,
      id: `/dubbed${anime.eps[16].id}`
    },
    ep18: {
      name: `${anime.name2} - EP #${anime.eps[17].ep_num}`,
      id: `/dubbed${anime.eps[17].id}`
    },
    ep19: {
      name: `${anime.name2} - EP #${anime.eps[18].ep_num}`,
      id: `/dubbed${anime.eps[18].id}`
    },
    ep20: {
      name: `${anime.name2} - EP #${anime.eps[19].ep_num}`,
      id: `/dubbed${anime.eps[19].id}`
    },
    ep21: {
      name: `${anime.name2} - EP #${anime.eps[20].ep_num}`,
      id: `/dubbed${anime.eps[20].id}`
    },
    ep22: {
      name: `${anime.name2} - EP #${anime.eps[21].ep_num}`,
      id: `/dubbed${anime.eps[21].id}`
    },
    ep23: {
      name: `${anime.name2} - EP #${anime.eps[22].ep_num}`,
      id: `/dubbed${anime.eps[22].id}`
    },
    ep24: {
      name: `${anime.name2} - EP #${anime.eps[23].ep_num}`,
      id: `/dubbed${anime.eps[23].id}`
    },
    ep25: {
      name: `${anime.name2} - EP #${anime.eps[24].ep_num}`,
      id: `/dubbed${anime.eps[24].id}`
    }
  });
});
...
router.get('/1', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name1} - EP #${anime.eps[0].ep_num}`,
    vidUrl: anime.eps[0].src,
    listid: anime.id,
    previd: `/dubbed${anime.eps[24].id}`,
...
router.get('/2', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name1} - EP #${anime.eps[1].ep_num}`,
...
router.get('/3', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name1} - EP #${anime.eps[2].ep_num}`,
...
router.get('/4', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name1} - EP #${anime.eps[3].ep_num}`,
...
router.get('/5', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name1} - EP #${anime.eps[4].ep_num}`,
...
router.get('/6', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name1} - EP #${anime.eps[5].ep_num}`,
...
router.get('/7', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name1} - EP #${anime.eps[6].ep_num}`,
...
router.get('/8', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name1} - EP #${anime.eps[7].ep_num}`,
...
router.get('/9', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name1} - EP #${anime.eps[8].ep_num}`,
...
router.get('/10', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name1} - EP #${anime.eps[9].ep_num}`,
...
router.get('/11', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name1} - EP #${anime.eps[10].ep_num}`,
...
router.get('/12', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name1} - EP #${anime.eps[11].ep_num}`,
...
router.get('/13', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name1} - EP #${anime.eps[12].ep_num}`,
...
router.get('/14', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name2} - EP #${anime.eps[13].ep_num}`,
...
router.get('/15', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name2} - EP #${anime.eps[14].ep_num}`,
...
router.get('/16', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name2} - EP #${anime.eps[15].ep_num}`,
...
router.get('/17', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name2} - EP #${anime.eps[16].ep_num}`,
...
router.get('/18', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name2} - EP #${anime.eps[17].ep_num}`,
...
router.get('/19', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name2} - EP #${anime.eps[18].ep_num}`,
...
router.get('/20', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name2} - EP #${anime.eps[19].ep_num}`,
...
router.get('/21', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name2} - EP #${anime.eps[20].ep_num}`,
...
router.get('/22', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name2} - EP #${anime.eps[21].ep_num}`,
...
router.get('/23', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name2} - EP #${anime.eps[22].ep_num}`,
...
router.get('/24', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name2} - EP #${anime.eps[23].ep_num}`,
    vidUrl: anime.eps[23].src,
    listid: anime.id,
    previd: `/dubbed${anime.eps[22].id}`,
    nextid: `/dubbed${anime.eps[24].id}`
  });
});
...
router.get('/25', (req, res) => {
  ...
  res.render('vidPlayer.hbs', {
    pageTitle: `${anime.name2} - EP #${anime.eps[24].ep_num}`,
    vidUrl: anime.eps[24].src,
    listid: anime.id,
